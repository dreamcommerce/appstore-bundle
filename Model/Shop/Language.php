...
class Language extends ResourceDependent implements LanguageInterface
{
    /**
     * @var int
     */
     ...
     * @var \ArrayAccess
     */
    protected $shippingTranslations;
    ...
    public function __construct()
    {
        ...
        $this->shippingTranslations = new \ArrayObject();
     ...
     * @return \ArrayAccess
     */
    public function getShippingTranslations()
    {
        return $this->shippingTranslations;
    }

    /**
     * @param \ArrayAccess $shippingTranslations
     * @return $this
     */
    public function setShippingTranslations($shippingTranslations)
    {
    ...
    /**
     * @param ShippingTranslationInterface $shippingTranslation
     * @return $this
     */
    public function addShippingTranslation(ShippingTranslationInterface $shippingTranslation)
    {
        $this->shippingTranslations[] = $shippingTranslation;
        return $this;
    }
